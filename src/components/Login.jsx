          ...
          <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
              <div className="mt-2">
                ...
                <h1 className="text-center mt-28 text-ts">All your personal details are safe with us.</h1>
                <h1 className="text-center mt-4 text-ts">If you continue, you are accepting <span className='text-blue-600'> OLX Terms and <br /> conditions and Privacy policy.</span></h1>
              </div>
            </div>
          </div>
        </div>
